...
We have provided you with extra simpledb.test cases as well
as source code files for this lab
that are not in the original code distribution you received. We again encourage you
to develop your own simpledb.test suite in addition to the ones we have provided.
...
verifying that you have passed the simpledb.test for the ant targets <tt>simpledb.test</tt> and
...
<tt>IntHistogramTest</tt> unit simpledb.test (you are not required to pass this simpledb.test if you
...
<tt>JoinOptimizerTest</tt>.  You should also pass the system simpledb.test
<tt>QueryTest</tt>.
