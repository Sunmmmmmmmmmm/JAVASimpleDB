...
public class BTreeDeadlockTest extends SimpleDbTestBase {
	...
	/**
	 * Not-so-unit simpledb.test to construct a deadlock situation.
	 * 
	 * This simpledb.test causes two different transactions to update two (probably) different leaf nodes
