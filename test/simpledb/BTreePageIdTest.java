...
public class BTreePageIdTest extends SimpleDbTestBase {
	...
	/**
	 * Unit simpledb.test for BTreePageId.getTableId()
	 */
	...
	/**
	 * Unit simpledb.test for BTreePageId.pageno()
	 */
	...
	/**
	 * Unit simpledb.test for BTreePageId.hashCode()
	 */
	@Test public void testHashCode() {
		int code1, code2, code3, code4;

		// NOTE(ghuo): the hashCode could be anything. simpledb.test determinism,
		// at least.
	...
	/**
	 * Unit simpledb.test for BTreePageId.equals()
	 */
