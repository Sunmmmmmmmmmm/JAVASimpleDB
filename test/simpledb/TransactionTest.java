...
public class TransactionTest extends TestUtil.CreateHeapFile {
  ...
  /**
   * Unit simpledb.test for BufferPool.transactionComplete().
  ...
  /**
   * Common unit simpledb.test code for BufferPool.transactionComplete() covering
  ...
  /**
   * Unit simpledb.test for BufferPool.transactionComplete() assuing commit.
  ...
  /**
   * Unit simpledb.test for BufferPool.transactionComplete() assuming abort.
   * Verify that a tuple inserted during a committed transaction is durable
   */
