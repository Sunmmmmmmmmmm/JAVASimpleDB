...
public class TupleDescTest extends SimpleDbTestBase {
    ...
    /**
     * Unit simpledb.test for TupleDesc.combine()
     */
    ...
    /**
     * Unit simpledb.test for TupleDesc.getType()
     */
    ...
    /**
     * Unit simpledb.test for TupleDesc.nameToId()
     */
    @Test public void nameToId() {
        int[] lengths = new int[] { 1, 2, 1000 };
        String prefix = "simpledb.test";
    ...
    /**
     * Unit simpledb.test for TupleDesc.getSize()
     */
    ...
    /**
     * Unit simpledb.test for TupleDesc.numFields()
     */
