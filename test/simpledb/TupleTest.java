...
public class TupleTest extends SimpleDbTestBase {
    ...
    /**
     * Unit simpledb.test for Tuple.getField() and Tuple.setField()
     */
    ...
    /**
     * Unit simpledb.test for Tuple.getTupleDesc()
     */
    ...
    /**
     * Unit simpledb.test for Tuple.getRecordId() and Tuple.setRecordId()
     */
	...
	try {
    	...
    	throw new UnsupportedOperationException("modifyRecordId() simpledb.test failed due to " +
