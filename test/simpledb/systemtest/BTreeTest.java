...
/**
 * System simpledb.test for the BTree
 */
public class BTreeTest extends SimpleDbTestBase {
    ...
    @Test public void testBigFile() throws Exception {
    	// For this simpledb.test we will decrease the size of the Buffer Pool pages
		...
		// we will need more room in the buffer pool for this simpledb.test
    ...
    /** Make simpledb.test compatible with older version of ant. */
